      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        {screen === "choose" && (
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-4">
            ...
            <button onClick={() => reset("dev")} style={{ background: "#8FBC8F" }} className="w-full hover:opacity-90 py-3 rounded-xl font-semibold text-sm text-white transition-colors">Responder Questionario</button>
